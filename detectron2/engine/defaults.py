...
class DefaultTrainer(SimpleTrainer):
    ...
    def build_hooks(self):
        ...
        # we can use the saved checkpoint to debug.save
    ...
    def build_train_loader(cls, cfg):
        my_dataset_name = 'car'
        json_annotation = "/home/ztp/detectron2-master/datasets/coco/annotations/trainann.json"
        image_dir = "/home/ztp/detectron2-master/datasets/coco/train2014"
        aa = register_coco_instances(my_dataset_name, {}, json_annotation, image_dir)
        a = DatasetCatalog.get("car")
        dataset = DatasetFromList(a)
...
"""
    ...
    def test(cls, cfg, model, evaluators=None):
        ...
        results = OrderedDict()
        for idx, dataset_name in enumerate(["car"]):
