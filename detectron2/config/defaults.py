...
_C.MODEL.META_ARCHITECTURE = "Hourg"
...
_C.MODEL.PIXEL_MEAN = [127.5, 127.5, 127.5]
...
_C.MODEL.BACKBONE.NAME = "Hourglass"
...
_C.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 768
...
_C.SOLVER.STEPS = (20000, 40000, 60000,80000,100000,120000)

_C.SOLVER.WARMUP_FACTOR = 1.0 / 10
